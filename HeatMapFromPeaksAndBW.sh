...
plotHeatmap -m ComputeMatrix_${SUFFIX}.gz -out ComputeMatrix_${SUFFIX}.png --whatToShow 'heatmap and colorbar' --dpi 300 --boxAroundHeatmaps no --colorList 'white,blue' --interpolationMethod nearest --missingDataColor white --startLabel S --endLabel E -min 0 -max 20
